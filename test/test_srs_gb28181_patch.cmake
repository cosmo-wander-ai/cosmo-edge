...
foreach(attempt RANGE 1 2)
    execute_process(COMMAND "${CMAKE_COMMAND}" "-DSRS_SOURCE_DIR=${test_source_dir}"
        -P "${TEST_PROJECT_ROOT}/cmake/patch_srs_gb28181_loss.cmake"
        RESULT_VARIABLE result)
    if(NOT result EQUAL 0)
        message(FATAL_ERROR "GB RTP loss patch failed")
    endif()
    file(READ "${test_source_file}" loss_source)
    if(attempt EQUAL 1)
        set(first_loss_source "${loss_source}")
    elseif(NOT loss_source STREQUAL first_loss_source)
