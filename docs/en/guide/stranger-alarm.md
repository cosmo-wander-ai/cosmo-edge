...
Pedestrian detection → pedestrian tracking → face association (`AA_00006`) → existing face quality classifier → face landmarks → face recognition → positive evidence retention (`BA_20003`) → event reporting.
