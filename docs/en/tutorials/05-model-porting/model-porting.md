...
> **Prerequisites**: Completed Volume 4: Pipeline Orchestration; understand basic pipeline orchestration concepts
> **Extra environment needed**: A computer with Docker installed for model conversion

Volume 4 covered "how to organize existing capabilities." This volume covers "how to bring in new ones." In other words:

+ **Volume 4** teaches you to orchestrate pipelines
+ **Volume 5** teaches you to introduce third-party models
...
<!-- Screenshots of region judgment -->
![](images/img_34.png)
![](images/img_35.png)
...
| Task starts but no bounding boxes | Missing OSD overlay node | Add a visualization overlay at the end of the pipeline |
