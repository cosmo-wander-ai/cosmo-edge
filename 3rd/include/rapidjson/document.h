...
public:
    ...
    */
    ...
    ConstMemberIterator MemberEnd() const   { if (!IsObject()){ConstMemberIterator tmp;return tmp;} RAPIDJSON_ASSERT(IsObject()); return ConstMemberIterator(GetMembersPointer() + data_.o.size); }
