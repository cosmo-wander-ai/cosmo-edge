...
[此处为语雀卡片，点击链接查看](about:blank#BRmDX)
...
| 算法名称   | 检测目标     | 告警条件           | 关键参数 |
| ---------- | ------------ | ------------------ | -------- |
| 未戴厨师帽 | 厨房人员头部 | 检测到未佩戴厨师帽 | 告警间隔 |
| 未穿厨师服 | 厨房人员上身 | 检测到未穿厨师服   | 告警间隔 |
| 老鼠检测   | 小型动物     | 检测到疑似老鼠     | 灵敏度   |
| 烟雾检测   | 烟雾         | 检测到异常烟雾     | 灵敏度   |
...
| 打架检测     | 多人交互 | 检测到暴力行为     | 灵敏度               |
| 电动车进电梯 | 电动车   | 电梯内检测到电动车 | 区域配置             |
| 火焰检测     | 明火     | 检测到火焰         | 灵敏度               |
